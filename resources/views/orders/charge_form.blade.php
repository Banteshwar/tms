...
<div class="m-portlet__body">								
	<div class="form-group m-form__group row">
		...
		<div class="col-lg-2">
			{!! Form::text('units', null, ['class' => 'form-control m-input numericOnly','id'=>'units','placeholder'=>'Units']) !!}
			
		</div>
		<div class="col-lg-2">

			{!! Form::text('rates', null, ['class' => 'form-control m-input numericOnly','id'=>'rates','placeholder'=>'Rates']) !!}
			
		</div>
		<div class="col-lg-2">

			{!! Form::text('amounts', null, ['class' => 'form-control m-input numericOnly','id'=>'amounts','placeholder'=>'Amounts*']) !!}
