	...
	<div class="m-portlet__body">
		...
		<div class="form-group m-form__group row">
			<div class="col-lg-2">
				...
				<label class="col-form-label">
					Customer or Billee<sup>*</sup>
				</label>
			</div>
			<div class="col-lg-3">											
					{{ Form::select('customer_billee_name', $arrCustomers, null,  ['class' => 'form-control m-input', 'id' => 'customer_billee_name' ]) }}
				
			</div>

			<div class="col-lg-2">											
				<label class="col-form-label">
					Appointment at customer<sup>*</sup>
				</label>
			</div>
			<div class="col-lg-4">
...
<script type="text/javascript">
  ...
  type = $(this).data('type');
   ...
   if(type =='customername' )autoType='customerfield';
   ...
   $(this).autocomplete({   
       ...
       source: function( request, response ) {   
            $.ajax({
                url: "{{ route('order.searchCustomerAjax') }}",
                dataType: "json",
                data: {
                    term : request.term,
                    type : type,
       ...
       select: function( event, ui ) {
           ...
           elementId = id[id.length-1];
            ...
            $('#customer_'+elementId).val(data.addressfield);
