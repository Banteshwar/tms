			...
			<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
				<div class="row align-items-center">
					...
					<div class="col-xl-4 order-1 order-xl-2 m--align-right">
						<a href="{{url('/admin/order/basicinfo')}}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
							<span>
						...
						@forelse ($arrOrders as $order)
							<tr data-row="0" class="m-datatable__row m-datatable__row--even" style="height: 43px;">
								...
								<td data-field="Owner" class="m-datatable__cell">
									<span style="width: 220px;">{{ $order->customer_billee_name }} </span>
								</td>

								<td data-field="Owner" class="m-datatable__cell">
									{{ $order->appointment_date  }} </span>
								</td>

								<td data-field="Terminated On" class="m-datatable__cell">
									{{ $order->ship_rail_line }} </span>
								</td>
								...
								<td data-field="Status" class="m-datatable__cell">
									<a href="{{url("/admin/order/dispatch/{$order->id}")}}">Check</a></span>

								</td>

								<td data-field="Status" class="m-datatable__cell">
									<a href="{{url("/admin/order/complete/{$order->id}")}}">Check</a></span>

								</td>

								<td data-field="Edit" class="m-datatable__cell">
									
										<a href="{{url("/admin/order/edit_basicinfo/{$order->id}")}}"><i class="la la-edit"></i></a>
									</span>
								</td>
